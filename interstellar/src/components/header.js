...
export default function Header() {
  return (
    <section class="pb-20 bg-black">
      ...
      <div
        class="relative container px-4 pt-12 md:pt-20 mx-auto"
        id="header-div"
      >
        <div class="flex flex-wrap items-center -mx-4 mb-20 2xl:mb-14">
          <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
            <h2
              class="max-w-2xl mt-12 mb-12 text-6xl 2xl:text-8xl text-white font-bold font-heading"
              id="header-h1"
            >
              Lets explore the cosmos together. Right here.
            </h2>
            <a
              class="inline-block px-12 py-5 text-lg text-white font-bold bg-blue-500 hover:bg-blue-600 rounded-full transition duration-200"
              href="#"
            >
              Learn how
            </a>
        ...
        <nav class="relative flex flex-col py-8 h-full w-full bg-white overflow-y-auto">
          <div class="flex items-center mb-16 pr-6">
            <a class="ml-10 mr-auto text-2xl text-gray-800 font-bold" href="#">
              <img class="h-7" src="/moon.png" alt="" width="auto" />
            </a>
          </div>
          <div>
            <ul>
